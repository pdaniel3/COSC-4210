<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="CollectInformation.ascx.cs" Inherits="COSC4210.MusicalIntruments.Web.Control.CollectItemControl" %>

<asp:Panel ID="enterInfoPanel" runat="server">
    <h1>Homework 7</h1>
    <h2>Instrument Information (Collected Using User Controls)</h2>
    <asp:Label
        ID="brandLabel"
        runat="server"
    ...
    <asp:DropDownList ID="typeDropDown" AutoPostBack="true" runat="server">
